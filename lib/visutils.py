...
def apply_brightness_factor(data, factor: float = 3.0):#: np.ndarray | Tensor, factor: float = 3.0) -> np.ndarray | Tensor:
...
def sequence2gallery(
        ...
        border_thickness: int = 2,
        border_color: Literal['black', 'white'] = 'black',
        indices_rgb = [0, 1, 2],#: List[int] | List[float] | Tensor = [0, 1, 2],
